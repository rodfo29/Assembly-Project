...
.data
    menu db 13,10,13,10,,13,10,13,10," 1) Determinar si un numero es par o impar",13,10,13,10," 2) Calcular el modulo de un numero",13,10,13,10," 3) Comprobar si un numero es positivo, negativo o cero",13,10,13,10," 4) Verificar si es multiplo de 3 o 5",13,10,13,10," 5) Mostrar Historial de calculos realizados",13,10,13,10," 6) limpiar el archivo del historial",13,10,13,10," 7) Salir de programa$",13,10,13,10 
    mensaje db 13,10,13,10,' Ingrese un numero de al menos 8 digitos:$'
    
    ;Mensajes de Bienvenida a las opciones 
    primer_opcion db 13,10,13,10,,13,10,13,10,"bienvenido a la primera opcion del menu",13,10,13,10,13,10,"$"
    segunda_opcion db 13,10,13,10,,13,10,13,10,"Bienvenido a la segunda opcion de menu",13,10,13,10,13,10,"$"
    tercera_opcion db 13,10,13,10,,13,10,13,10,"Bienvenido a la tercera opcion de menu",13,10,13,10,13,10,"$"  
    cuarta_opcion db 13,10,13,10,,13,10,13,10,"Bienvenido a la cuarta opcion de menu",13,10,13,10,13,10,"$"
    quinta_opcion db 13,10,13,10,,13,10,13,10,"Bienvenido a la quinta opcion de menu",13,10,13,10,13,10,"$"
    sexta_opcion db 13,10,13,10,,13,10,13,10,"Bienvenido a la sexta opcion de menu",13,10,13,10,13,10,"$"
    
    ; mensajes de la opcion 1
    es_par db 13,10,13,10,"el numero es par..$"
    es_impar db 13,10,13,10,"el numero es impar..$"
    
    
    ; mensajes de la opcion 2
    
    
    
    mensaje_despedida db 13,10,13,10,,13,10,13,10,"Saliendo del programa...$"      
    mensaje_error db 13,10,13,10,,13,10,13,10,"Opcion no valida.. por favor ingresar una opcion disponible.",13,10,13,10,13,10,"$"
...
start:
    ...
    ; Leer un carácter (un dígito) -> se guarda en al como ascii
    mov ah, 01h
    int 21h     
       ...
       limpiar_pantalla endp 
        ...
        es_par_impar proc 
          ...
          delay proc
                ...
                espera:
                nop             ; instrucción que no hace nada (opcional)
